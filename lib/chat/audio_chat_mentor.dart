...
class AudioChat extends StatefulWidget {
  ...
  @override
  _AudioChatState createState() =>
      new _AudioChatState(serverIP: ip, displayName: displayName);
}
      ...
      _signaling.onStateChange = (SignalingState state, String peerId) {
        switch (state) {
          case SignalingState.CallStateOutgoing:
            incall.start({'media': '', 'auto': true, 'ringback': '_DTMF_'});
            this.setState(() {
              _callState = state;
            });
            break;
