...
class VideoChatMentor extends StatefulWidget {
  final String ip = "95.110.175.35";
  final String displayName;

  VideoChatMentor({Key key, @required this.displayName}) : super(key: key);

  @override
  _VideoChatMentorState createState() =>
      new _VideoChatMentorState(serverIP: ip, displayName: displayName);
}

class _VideoChatMentorState extends State<VideoChatMentor> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: new AppBar(
        title: new Text('Connecting Video ...'),
        actions: <Widget>[
          IconButton(
              icon: _connected
      ...
      body: _callState == SignalingState.CallStateIncoming ||
          ...
          : _peers == null || _peers.length == 0
              ? Center(
                  child: _connected
                      ? Text(
                          'User not connected yet, please wait',
